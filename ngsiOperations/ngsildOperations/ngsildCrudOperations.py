...
def ngsi_get_historical(entity,  mintaka, mintaka_port, context, context_port, attribute = "data", window_length=5000):  # double check on EMG sensor entity what attribute reprements the signal values
    """
